              ...
              <v-col cols="12" sm="12">
                <v-app-bar color="rgba(0,0,0,0)" flat class="mx-8 mb-8 mt-3">
                  ...
                  <v-chip class="ma-2" color="white">
                    ...
                    10:01 AM Today Sept, 22 
                  </v-chip>
                </v-app-bar>
              </v-col>
              <v-col cols="12" sm="12">
                <v-card class="mx-12 rounded-tr-xl rounded-br-xl mt-n15">
...
<v-list-item-content class="pa-10">
  ...
  <v-list-item-subtitle>
    The package price includes: consulations<br>
    odf a pulmonologist, spirography, cardiogram <span class="teal--text">></span>
  </v-list-item-subtitle>
</v-list-item-content>
<v-list-item-avatar tile size="150" class="pr-10">

<img src="https://i.postimg.cc/XJPxg3jZ/lung-human-anatomy-biology-organ-body-system-health-care-medical-hand-drawn-cartoon-art-illustration.jpg" alt="lungs">
              ...
              <v-col cols="12" sm="12">
                <v-card class="mx-12 rounded-tr-xl rounded-bl-xl rounded-br-xl mt-n10">
...
<template>
  ...
  >
              ...
              <v-col cols="12" sm="6">
                <v-card class="mx-12 rounded-tl-xl rounded-br-xl mt-n4" color="teal" dark>
<v-list-item three-line>
  ...
  <v-list-avatar title size="150" class="pr-10">
    <v-icon size="100">fas fa-heartbeat</v-icon>
              ...
              <v-col cols="12" sm="6">
                <v-card class="mx-12 rounded-tl-xl rounded-br-xl mt-n12">
<v-app-bar color="rgba(0,0,0,0)" flat class="ma-8">
  <h5>Your Activity</h5>
  <v-spacer></v-spacer>
...
<v-col cols="12" sm="12">
  <v-card class="mx-12 rounded-tl-xl rounded-bl-xl rounded-br-xl mt-n4 py-4" color="teal" dark flat>
    <v-list-item three-line>
...
<v-list-item three-line>
  <v-list-item-avatar tile size="30">
    <v-icon size="30">fas fa-headbeat</v-icon>
  </v-list-item-avatar>
  <v-list-item-content class="pa-2">
    <v-list-item-title class="headline mb-1">
      Cardiologist<br>
...
<v-list-item three-line>
  ...
  <v-list-item-content class="pa-2">
    <v-list-item-title class="headline mb-1">
      Gentle Iron<br>
      <h6><span class="teal--text">2 capsules</span>
      with meals every day</h6>
    </v-list-item-title>
  </v-list-item-content>
</v-list-item>
  </v-card>
